 ...
 * falls back to the theme's original implicit nav (nav categories, then
 * every page, then rss — this theme never showed a "Home" link, since the
 * site title itself already links home) so sites that predate the menu
